...
class Program {
 ...
 private:
  ...
  // Map NNAdapter operand to lyf device tensor
  std::map<core::Operand*, std::vector<lyf_device::Tensor*>> tensors_;
  std::shared_ptr<lyf_device::Graph> graph_{nullptr};
  std::shared_ptr<lyf_device::Execution> execution_{nullptr};
