 ...
 *     std::vector<lyf_device::Tensor*> inputs, outputs;
 ...
 *     ...   // fill attr
 *     graph->AddOperator(lyf_device::OperatorType::CONV2D, inputs, outputs,
 * reinterpret_cast<void*>(&attr));
 * </pre>
*/

typedef enum { LYF_DEVICE_CONV2D = 0 } OperatorType;
