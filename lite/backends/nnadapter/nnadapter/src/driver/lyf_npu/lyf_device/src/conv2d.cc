...
int conv2d(Tensor* input_tensor,
  ...
  if (input_precision == PrecisionType::QUANT_INT8_SYMM_PER_LAYER) {
    ...
    LYF_DEVICE_CHECK(input_precision == PrecisionType::FLOAT32)
  ...
  if (filter_precision == PrecisionType::QUANT_INT8_SYMM_PER_LAYER) {
    ...
    LYF_DEVICE_CHECK(filter_precision == PrecisionType::FLOAT32)
  ...
  if (bias_tensor) {
    ...
    LYF_DEVICE_CHECK_EQ(bias_count, output_channel_size);
    ...
    if (bias_precision == PrecisionType::QUANT_INT32_SYMM_PER_LAYER) {
      ...
      LYF_DEVICE_CHECK(bias_precision == PrecisionType::FLOAT32)
  ...
  if (output_precision == PrecisionType::QUANT_INT8_SYMM_PER_LAYER ||
    ...
    LYF_DEVICE_CHECK(output_precision == PrecisionType::FLOAT32)
